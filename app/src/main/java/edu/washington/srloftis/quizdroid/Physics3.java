...
public class Physics3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> message = intent.getStringArrayListExtra(Physics2.EXTRA_MESSAGE);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (answer != -1) {
                    ...
                    Intent intent = new Intent(Physics3.this, Physics4.class);
