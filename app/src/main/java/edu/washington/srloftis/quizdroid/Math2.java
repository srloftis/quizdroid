...
public class Math2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> message = intent.getStringArrayListExtra(Math1.EXTRA_MESSAGE);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Math2.this, Math3.class);
