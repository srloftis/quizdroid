...
public class MH4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> message = intent.getStringArrayListExtra(MH3.EXTRA_MESSAGE);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MH4.this, MainActivity.class);
